package com.omar.produits.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	/*	System.out.println("Passwors Encoded BCRYPT :******************** ");
		...
		auth.inMemoryAuthentication().withUser("omar").password(passwordEncoder.encode("123")).roles("AGENT", "USER");
		auth.inMemoryAuthentication().withUser("ala").password(passwordEncoder.encode("123")).roles("USER");*/
	}
